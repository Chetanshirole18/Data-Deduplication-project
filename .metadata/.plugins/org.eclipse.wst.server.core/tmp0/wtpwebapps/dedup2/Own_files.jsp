...
<div style="margin-left: 20px;margin-right: 20px">
        ...
        %>
           <TR>
               ...
               <TD> <a href="DownloadFileServlet?id=<%=resultset.getString(1)%>&filename=<%=resultset.getString(2) %>&filepath=<%=resultset.getString(4) %>&hash=<%=resultset.getString(5) %>&status=<%=resultset.getString(7) %>"><input type="button" name="Download" value="Download" class="btn btn-info"></a></TD>
               <TD> <a href="Delete?filename=<%=resultset.getString(2)%>&id=<%=resultset.getString(1) %>&filepath=<%=resultset.getString(4) %>&hash=<%=resultset.getString(5) %>&status=<%=resultset.getString(7) %>"><input type="button" name="Delete" value="Delete" class="btn btn-danger"></a></TD>
           </TR>
       <% 
           } 
       %>
