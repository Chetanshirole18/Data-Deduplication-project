...
<div class="container"  align="center">
  ...
  <h5>Please contact to the owner of a file to get File Tag</h5>
  <div class="panel panel-default" style="width: 50%">
    <div class="panel-heading"><h4>Enter File Tag</h4></div>
    <div class="panel-body">
    <form action="OtherFileDownload" method="post" autocomplete="off">
        <div class="form-group" align="left">
            <input type="text" name="key" class="form-control" placeholder="Enter File Tag here" required>
        </div>
