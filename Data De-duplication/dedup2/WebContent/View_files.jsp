...
<div style="margin-left: 20px;margin-right: 20px">
        ...
        %>
           <TR>
               ...
               <TD> <a href="otherFileDownload.jsp?file=<%=resultset.getString(2)%>&owner=<%=resultset.getString(3)%>&id=<%=resultset.getString(1)%>&filename=<%=resultset.getString(2) %>&filepath=<%=resultset.getString(4) %>&hash=<%=resultset.getString(5) %>&status=<%=resultset.getString(7) %>"><input type="button" name="Request" value="Request" class="btn btn-info"></a></TD>
           	   <TD> <a href="Other_download.jsp?file=<%=resultset.getString(2)%>&owner=<%=resultset.getString(3)%>&id=<%=resultset.getString(1)%>&filename=<%=resultset.getString(2) %>&filepath=<%=resultset.getString(4) %>&hash=<%=resultset.getString(5) %>&status=<%=resultset.getString(7) %>"><input type="button" name="Download" value="Download" class="btn btn-info"></a></TD>
